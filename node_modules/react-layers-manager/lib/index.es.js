  ...
  createClass(LayersManager, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement("div", { ref: this.host, style: { opacity: 0.9999999 } })
      );
    }
  }]);
...
var Layer = function Layer(props) {
  return React.createElement(
    ...
    function (_ref) {
      var host = _ref.host,
          root = _ref.root;
      return host && root && React.createElement(LayerImpl, _extends({}, props, { host: host, root: root }));
    }
  );
};
